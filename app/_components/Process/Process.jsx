...
const Process = () => {
  return (
    ...
    <div className="relative">
      ...
      <div className="xl:px-36 md:px-16 py-8 px-4 gap-5 md:gap-10 mt-20 flex items-center flex-col">
      <h1 className="text-center md:text-3xl font-semibold md:mb-10">Sürec Nasıl İşliyor ?</h1>
